---
title: 'De um servidor Debian a uma plataforma Kubernetes em casa'
description: 'Como um servidor Debian virou um cluster K3s single-node com Traefik, Cloudflare Tunnel, storage e firewall — sem migração big bang.'
date: 2026-09-17
slug: k3s-homelab
tags: [kubernetes, homelab, infraestrutura]
draft: false
lang: pt
