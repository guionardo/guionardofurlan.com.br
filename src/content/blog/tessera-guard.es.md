...
description: "Un proyecto en desarrollo que reúne licencias, control de ejecución y telemetría en una plataforma gestionada."
date: 2026-09-11
slug: tessera-guard-licenciamiento-escritorio
tags: ["Licenciamiento", "Desktop", "Observabilidad"]
draft: true
lang: es
translationKey: tessera-guard-introduction
---

En este post presento Tessera Guard, un proyecto en desarrollo centrado en el licenciamiento y el seguimiento de aplicaciones distribuidas.
...
La presentación completa está en la [página del proyecto](/es/proyectos/tessera-guard/).
