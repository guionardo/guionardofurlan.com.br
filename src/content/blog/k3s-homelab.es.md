---
title: 'De un servidor Debian a una plataforma Kubernetes en casa'
description: 'Cómo un servidor Debian se convirtió en un clúster K3s de un solo nodo con Traefik, Cloudflare Tunnel, almacenamiento y firewall — sin una migración tipo big bang.'
date: 2026-09-17
slug: k3s-homelab-servidor-debian
tags: [kubernetes, homelab, infraestructura]
draft: false
lang: es
translationKey: homelab-k3s
seriesKey: homelab-k3s
seriesOrder: 1
---
