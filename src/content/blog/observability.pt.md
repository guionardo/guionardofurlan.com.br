---
title: 'Observabilidade de verdade em um Kubernetes pequeno'
description: 'Métricas, logs e traces em um cluster single-node: a stack Prometheus/Loki/Tempo, correlação por trace_id e o custo real da observabilidade.'
date: 2026-09-17
slug: observabilidade
tags: [kubernetes, homelab, observabilidade]
draft: false
lang: pt
